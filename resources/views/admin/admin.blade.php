    ...
    <div class="content-wrap">
        <div class="main">
            <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="stat-widget-one">
                              ...
                              <div class="stat-content dib">
                                <div class="stat-text">จำนวนเอกสารการจัดซื้อทั้งหมด</div>
                                <div class="stat-digit">{{$CountReqFormbuy}}</div>
                              </div>
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="stat-widget-one">
                              ...
                              <div class="stat-content dib">
                                <div class="stat-text">จำนวนเอกสารการจัดจ้างทั้งหมด</div>
                                <div class="stat-digit">{{$CountReqFormhire}}</div>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="stat-widget-one">
                              ...
                              <div class="stat-content dib">
                                <div class="stat-text">จำนวนเจ้าหน้าที่พัสดุคณะทั้งหมด</div>
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="stat-widget-one">
                              ...
                              <div class="stat-content dib">
                                <div class="stat-text">จำนวนเจ้าหน้าที่พัสดุสาขาทั้งหมด</div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <h3 style="margin-left: 20px; margin-top: 20px">เมนูลัด</h3>
                    </div>

                    <div class="col-lg-7">
                        <h3 style="margin-left: 20px; margin-top: 20px">ข่าวประชาสัมพันธ์</h3>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4" style="margin-left: 60px;">
                        ...
                        <div style=" margin-top: 20px;">
                            ...
                            <a class="btn btn-success btn-outline m-b-10 m-l-5" href="admin-information">แจ้งประชาสัมพันธ์</a>
                        </div>

                        <div style=" margin-top: 20px;">
                            <span class="ti-arrow-circle-right"></span>
                            <a class="btn btn-warning btn-outline m-b-10 m-l-5" href="form-list">รายการคำร้องแบบฟอร์ม</a>       
                        </div>

                        <div style=" margin-top: 20px;">
                            <span class="ti-arrow-circle-right"></span>
                            <a class="btn btn-info btn-outline m-b-10 m-l-5" href="staff-add-new">เพิ่มข้อมูลเจ้าหน้าที่พัสดุสาขา</a> 
                        </div>

                        <div style=" margin-top: 20px;">
                            <span class="ti-arrow-circle-right"></span>
                            <a class="btn btn-pink btn-outline m-b-10 m-l-5" href="admin-add-new">เพิ่มข้อมูลเจ้าหน้าที่พัสดุคณะ</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7">
                        <table id="bootstrap-data-table-list" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                @if($infoAll->count())      
                                    @foreach ($infoAll as $infoAllData)   
                                    <tr>
                                        <td>{{$infoAllData->infoName}}</td>
                                        <td>{{$infoAllData->infoContent}}</td>
                                        <td>{{$infoAllData->infoAuthorName}}</td>
                                        <td>{{$infoAllData->created_at}}</td>                                        
                                    </tr> 
                                    @endforeach     
                                @endif 
                        ...
                        <div style="margin-top: 20px;">
                            {!! $infoAll->appends(\Request::except('page'))->render() !!}
                        </div>
