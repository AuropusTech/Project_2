            ...
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 20px">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="card">
                            <div class="topics">
                                <center><h2 style="margin-bottom: 30px;">แก้ไขข้อมูลหลัก</h2></center>                                 
                            </div>

                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="authAdminUpdate" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <input type="text" hidden value="{{ Auth::user()->articleName }}" name="articleName">
                                                <input type="text" hidden value="{{ Auth::user()->sysRole }}" name="sysRole">
                                                <input type="text" hidden value="{{ Auth::user()->deptCode }}" name="deptCode">

                                                <input style="margin-top: 10px;" type="text" value="{{ Auth::user()->sysRole }}" class="form-control" name="email" hidden>

                                                <h5>ชื่อ : <input style="margin-top: 10px;" type="text" value="{{ Auth::user()->fname }}" class="form-control" name="fname" required></h5>

                                                <h5>นามสกุล : <input style="margin-top: 10px;" type="text" value="{{ Auth::user()->lname }}" class="form-control" name="lname" required></h5>

                                                <h5>ตำแหน่ง : <input style="margin-top: 10px;" type="text" value="{{ Auth::user()->position }}" class="form-control" name="position" readonly></h5>

                                                <h5>Email : <input style="margin-top: 10px;" type="text" value="{{ Auth::user()->email }}" class="form-control" name="email" required></h5>

                                                <h5>Password : <input style="margin-top: 10px;" type="password" class="form-control" required placeholder="กรุณากรอกรหัสผ่านใหม่" name="password" required></h5>
                                        ...
                                        <div class="row" style="margin-top: 20px">
                                            <div class="col-md-6">
                                                <a style="float: right;" class="btn btn-danger btn-rounded m-b-10 m-l-5" href="admin">ยกเลิก</a>
                                            </div>

                                            <div class="col-md-6">
                                                <button style="float: left;" class="btn btn-success btn-rounded m-b-10 m-l-5" type="submit" onclick="myFunction()">บันทึกข้อมูล</button>
                                            </div>
                                        </div>
