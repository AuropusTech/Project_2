        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="card">
                            <h3 style="margin-bottom: 20px;"><center>ข้อมูลงบประมาณ</center></h3>
                            <div class="bootstrap-data-table-panel">
                                <div class="table-responsive">
                                    <a href="budgetDataInsert" class="btn btn-success m-b-10 m-l-5" style="float: right; margin-bottom: 10px; margin-right: 5px;">+ เพิ่มประเภทงบประมาณ</a>
                                    <table id="bootstrap-data-table-list" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                <th>@sortablelink('ID')</th>
                                                <th>ประเภทของงบประมาณ</th>
                                                <th>การดำเนินการ</th>
                                            </tr>
                                        </thead>
                                       ...
                                       <tbody>
                                            @if($budgets->count())
                                            @foreach ($budgets as $showBudgets)
                                            <tr>
                                                <td>{{$showBudgets->id}}</td>
                                                <td>{{$showBudgets->budgetType}}</td>
                                                <td><a style="color: blue" href="budgetDataEdit/{{$showBudgets['id']}}">แก้ไขข้อมูล</a>&nbsp;&nbsp;<a style="color: red" href="{{url('budgetDataDelete/'.$showBudgets->id)}}" onclick="myFunction()">ลบ</a></td>
                                            </tr> 
                                            @endforeach
                                            @endif
                                        </tbody>
                                    ...
                                    <div style="margin-top: 20px;">
                                        {!! $budgets->appends(\Request::except('page'))->render() !!}
                                    </div>
