        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="card">
                            <h3 style="margin-bottom: 20px;"><center>ข้อมูลสาขา</center></h3>
                            <div class="bootstrap-data-table-panel">
                                <div class="table-responsive">
                                    <a href="deptDataInsert" class="btn btn-success m-b-10 m-l-5" style="float: right; margin-bottom: 10px; margin-right: 5px;">+ เพิ่มสาขา</a>
                                       ...
                                       <tbody>
                                            @if($depts->count())
                                                @foreach ($depts as $showDepts)
                                                    <tr>
                                                        <td>{{$showDepts->id}}</td>
                                                        <td>{{$showDepts->deptName}}</td>
                                                        <td>{{$showDepts->factName}}</td>
                                                        <td>
                                                            <a style="color: blue" href="deptDataEdit/{{$showDepts['id']}}">แก้ไขข้อมูล</a>&nbsp;&nbsp;
                                                            <a style="color: red" href="{{url('deptDataDelete/'.$showDepts->id)}}" onclick="myFunction()">ลบ</a>
                                                        </td>
                                                    </tr> 
                                                @endforeach
                                            @endif
                                    ...
                                    <div style="margin-top: 20px;">
                                        {!! $depts->appends(\Request::except('page'))->render() !!}
                                    </div>
