                ...
                <!-- ADD HERE -->
                    <div class="row" style="margin-bottom: 20px">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="card">
                                <div class="topics">
                                    <center><h2 style="margin-bottom: 30px;">เพิ่มข้อมูลประเภทงบประมาณ</h2></center>                                 
                                </div>

                                <div class="card-body">
                                    <div class="basic-form">
                                        <form method="POST" action="/budgetDataUpdate/{{$budgets['id']}}">
                                            @csrf
                                            <div class="form-group" style="margin-left: 50px">
                        
                                                <div class="row" style="margin-bottom: 25px">
                                                    <h6  style="margin: 10px;">ประเภทของงบประมาณ : </h6>
                                                    <input id="budgetType" name="budgetType" type="text" class="form-control input-default col-sm-4" required value="{{$budgets->budgetType}}">
