                ...
                <!-- /# row -->
                            ...
                            <div class="row" style="margin-bottom: 20px">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="card">
                                        <div class="topics">
                                            <center><h2 style="margin-bottom: 30px;">แก้ไขข้อมูลสาขา</h2></center>                                 
                                        </div>
        
                                        <div class="card-body">
                                            <div class="basic-form">
                                                <form method="POST" action="/deptDataUpdate/{{$depts['id']}}">
                                                    @csrf
                                                    <div class="form-group" style="margin-left: 50px">
                                
                                                        <div class="row" style="margin-bottom: 25px">
                                                            <h6  style="margin: 10px;">ชื่อสาขา : </h6>
                                                            <input id="deptName" name="deptName" type="text" class="form-control input-default col-sm-6" required value="{{$depts->deptName}}">
                                                        </div>
        

                                                        <div class="row" style="margin-bottom: 20px">
                                                            <h6 style="margin: 10px;">คณะ : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                                                            <div class="col-sm-4">
                                                                <select id="factCode'" name="factCode" class="form-control" style="border-radius: 5px">
                                                                    @foreach ($facts as $showFacts)
                                                                        <option value="{{$showFacts->id}}">{{$showFacts->factName}}</option>
                                                                    @endforeach
                                                                </select>
                                                    ...
                                                    <a href="{{ route('deptData') }}" style="margin-left: 25px; width: 80px;" class="btn btn-danger btn-rounded m-b-10 m-l-5">ยกเลิก</a>
