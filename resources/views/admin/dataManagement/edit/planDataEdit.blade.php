                ...
                <!-- /# row -->
                            ...
                            <div class="row" style="margin-bottom: 20px">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="card">
                                        <div class="topics">
                                            <center><h2 style="margin-bottom: 30px;">แก้ไขข้อมูลแผนงาน</h2></center>                                 
                                        </div>
        
                                        <div class="card-body">
                                            <div class="basic-form">
                                                <form method="POST" action="/planDataUpdate/{{$plans['planCode']}}">
                                                    @csrf
                                                    <div class="form-group" style="margin-left: 50px">
                                                        ...
                                                        <div class="row" style="margin-bottom: 25px">
                                                            ...
                                                            <input id="planCode" name="planCode" type="text" class="form-control input-default col-sm-6" required value="{{$plans->planCode}}">
                                                        </div>
                                
                                                        <div class="row" style="margin-bottom: 25px">
                                                            <h6  style="margin: 10px;">ชื่อแผนงาน : </h6>
                                                            <input id="planName" name="planName" type="text" class="form-control input-default col-sm-6" required value="{{$plans->planName}}">
                                                        </div>

                                                        <div class="row" style="margin-bottom: 20px">
                                                            <h6 style="margin: 10px;">ประเภทแผนงานงบประมาณ : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                                                            <div class="col-sm-4">
                                                                <select id="planBudgetId'" name="planBudgetId" class="form-control" style="border-radius: 5px">
                                                                    @foreach ($planBudgets as $showPlanBudget)
                                                                        <option value="{{$showPlanBudget->planBudgetCode}}">{{$showPlanBudget->planBudgetName}}</option>
                                                                    @endforeach
                                                                </select>
                                                    ...
                                                    <a href="{{ route('planData') }}" style="margin-left: 25px; width: 80px;" class="btn btn-danger btn-rounded m-b-10 m-l-5">ยกเลิก</a>
