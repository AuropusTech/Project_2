                ...
                <!-- /# row -->
                            ...
                            <div class="row" style="margin-bottom: 20px">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="card">
                                        <div class="topics">
                                            <center><h2 style="margin-bottom: 30px;">แก้ไขข้อมูลแผนงานย่อย</h2></center>                                 
                                        </div>
        
                                        <div class="card-body">
                                            <div class="basic-form">
                                                <form method="POST" action="/subPlanDataUpdate/{{$subPlans['id']}}">
                                                    @csrf
                                                    <div class="form-group" style="margin-left: 50px">

                                                        <div class="row" style="margin-bottom: 25px">
                                                            <h6  style="margin: 10px;">รหัสแผนงานย่อย : </h6>
                                                            <input id="subPlanCode" name="subPlanCode" type="text" class="form-control input-default col-sm-6" required  value="{{$subPlans->subPlanCode}}">
                                                        </div>
                                                        	
                                                        <div class="row" style="margin-bottom: 25px">
                                                            <h6  style="margin: 10px;">ชื่อแผนงานงบย่อย : </h6>
                                                            <input id="subPlanName" name="subPlanName" type="text" class="form-control input-default col-sm-6" required  value="{{$subPlans->subPlanName}}">
                                                        </div>
            
                                                        <div class="row" style="margin-bottom: 20px">
                                                            <h6 style="margin: 10px;">ประเภทแผนงาน : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                                                            <div class="col-sm-4">
                                                                <select id="planId'" name="planId" class="form-control" style="border-radius: 5px">
                                                        ...
                                                        <div class="row" style="margin-bottom: 20px">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <select id="deptId'" name="deptId" class="form-control" style="border-radius: 5px">
                                                    ...
                                                    <a href="{{ route('subPlanData') }}" style="margin-left: 25px; width: 80px;" class="btn btn-danger btn-rounded m-b-10 m-l-5">ยกเลิก</a>
