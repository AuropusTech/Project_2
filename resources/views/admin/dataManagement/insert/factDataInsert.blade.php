                ...
                <!-- ADD HERE -->
                    <div class="row" style="margin-bottom: 20px">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="card">
                                <div class="topics">
                                    <center><h2 style="margin-bottom: 30px;">เพิ่มข้อมูลคณะ</h2></center>                                 
                                </div>

                                <div class="card-body">
                                    <div class="basic-form">
                                        <form method="POST" action="{{ route('factDataCreate') }}">
                                            @csrf
                                            <div class="form-group" style="margin-left: 50px">
                        
                                                <div class="row" style="margin-bottom: 25px">
                                                    <h6  style="margin: 10px;">ชื่อคณะ : </h6>
                                                    <input id="factName" name="factName" type="text" class="form-control input-default col-sm-6" required>
                                            ...
                                            <a href="factData" style="margin-left: 25px; width: 80px;" class="btn btn-danger btn-rounded m-b-10 m-l-5">ยกเลิก</a>
