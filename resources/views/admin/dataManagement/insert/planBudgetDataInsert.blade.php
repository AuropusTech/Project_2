            ...
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 20px">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="card">
                            <div class="topics">
                                <center><h2 style="margin-bottom: 30px;">เพิ่มข้อมูลแผนงานงบประมาณ</h2></center>                                 
                            </div>

                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="{{ route('planBudgetDataCreate') }}">
                                        @csrf
                                        <div class="form-group" style="margin-left: 50px">

                                            <div class="row" style="margin-bottom: 25px">
                                                <h6  style="margin: 10px;">รหัสแผนงานงบประมาณ : </h6>
                                                <input id="planBudgetCode" name="planBudgetCode" type="text" class="form-control input-default col-sm-6" required>
                                            </div>
                    
                                            <div class="row" style="margin-bottom: 25px">
                                                <h6  style="margin: 10px;">ชื่อแผนงานงบประมาณ : </h6>
                                                <input id="planBudgetName" name="planBudgetName" type="text" class="form-control input-default col-sm-6" required>
                                            </div>

                                            <div class="row" style="margin-bottom: 20px">
                                                <h6 style="margin: 10px;">ประเภทงบประมาณ : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                                                <div class="col-sm-4">
                                                    <select id="budgetTypeId" name="budgetTypeId" class="form-control" style="border-radius: 5px" required>
                                        ...
                                        <a href="budgetData" style="margin-left: 25px; width: 80px;" class="btn btn-danger btn-rounded m-b-10 m-l-5">ยกเลิก</a>
