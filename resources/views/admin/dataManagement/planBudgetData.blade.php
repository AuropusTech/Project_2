        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="card">
                            <h3 style="margin-bottom: 20px;"><center>ข้อมูลแผนงานงบประมาณ</center></h3>
                            <div class="bootstrap-data-table-panel">
                                <div class="table-responsive">
                                    <a href="planBudgetDataInsert" class="btn btn-success m-b-10 m-l-5" style="float: right; margin-bottom: 10px; margin-right: 5px;">+ เพิ่มข้อมูลแผนงานงบประมาณ</a>
                                    <table id="bootstrap-data-table-list" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                <th style="width: 400px;">รหัสแผนงานงบประมาณ ( @sortablelink('planBudgetCode') ) </th>
                                                <th>ชื่อแผนงานงบประมาณ</th>
                                       ...
                                       <tbody>
                                            @if($planBudgets->count())
                                                @foreach ($planBudgets as $showPlanBudgets)
                                                    <tr>
                                                        <td>{{$showPlanBudgets->planBudgetCode}}</td>
                                                        <td>{{$showPlanBudgets->planBudgetName}}</td>
                                                        <td>{{$showPlanBudgets->budgetType}}</td>
                                                        <td>
                                                            <a style="color: blue" href="planBudgetDataEdit/{{$showPlanBudgets['planBudgetCode']}}">แก้ไขข้อมูล</a>&nbsp;&nbsp;
                                                            <a style="color: red" href="{{url('planBudgetDataDelete/'.$showPlanBudgets->planBudgetCode)}}" onclick="myFunction()">ลบ</a>
                                                        </td>
                                                    </tr> 
                                                @endforeach
                                            @endif
                                    ...
                                    <div style="margin-top: 20px;">
                                        {!! $planBudgets->appends(\Request::except('page'))->render() !!}
                                    </div>
