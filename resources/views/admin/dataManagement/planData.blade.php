        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="card">
                            <h3 style="margin-bottom: 20px;"><center>ข้อมูลแผนงาน</center></h3>
                            <div class="bootstrap-data-table-panel">
                                <div class="table-responsive">
                                    <a href="planDataInsert" class="btn btn-success m-b-10 m-l-5" style="float: right; margin-bottom: 10px; margin-right: 5px;">+ เพิ่มข้อมูลแผนงาน</a>
                                    <table id="bootstrap-data-table-list" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                <th>รหัสแผนงาน @sortablelink('planCode')</th>
                                                <th>ชื่อแผนงาน</th>
                                                <th>ID แผนงานงบประมาณ</th>
                                       ...
                                       <tbody>
                                            @if($plans->count())
                                                @foreach ($plans as $showPlans)
                                                    <tr>
                                                        <td>{{$showPlans->planCode}}</td>
                                                        <td>{{$showPlans->planName}}</td>
                                                        <td>{{$showPlans->planBudgetId}}</td>
                                                        <td>{{$showPlans->planBudgetName}}</td>
                                                        <td>{{$showPlans->deptId}}</td>
                                                        
                                                        <td>
                                                            <a style="color: blue" href="planDataEdit/{{$showPlans['planCode']}}">แก้ไขข้อมูล</a>&nbsp;&nbsp;
                                                            <a style="color: red" href="{{url('planDataDelete/'.$showPlans->planCode)}}" onclick="myFunction()">ลบ</a>
                                                        </td>
                                                    </tr> 
                                                @endforeach
                                            @endif
