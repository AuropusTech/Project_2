        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="card">
                            <h3 style="margin-bottom: 20px;"><center>ข้อมูลตำแหน่ง</center></h3>
                            <div class="bootstrap-data-table-panel">
                                <div class="table-responsive">
                                    <a href="positionDataInsert" class="btn btn-success m-b-10 m-l-5" style="float: right; margin-bottom: 10px; margin-right: 5px;">+ เพิ่มตำแหน่ง</a>
                                    <table id="bootstrap-data-table-list" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$showPositions->id}}</td>
                                                <td>{{$showPositions->positionType}}</td>
                                                <td><a style="color: red" href="{{url('positionDataDelete/'.$showPositions->id)}}" onclick="myFunction()">ลบ</a></td>
                                            </tr> 
                                            @endforeach
                                            @endif
                                        </tbody>
