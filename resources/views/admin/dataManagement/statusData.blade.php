        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="card">
                            <h3 style="margin-bottom: 20px;"><center>ข้อมูลสถานะเอกสาร</center></h3>
                            <div class="bootstrap-data-table-panel">
                                <div class="table-responsive">
                                    <a href="statusDataInsert" class="btn btn-success m-b-10 m-l-5" style="float: right; margin-bottom: 10px; margin-right: 5px;">+ เพิ่มสถานะเอกสาร</a>
                                    <table id="bootstrap-data-table-list" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                <th>@sortablelink('ID')</th>
                                                <th>ประเภทสถานะเอกสาร</th>
                                                <th>การดำเนินการ</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$showStatuses->id}}</td>
                                                <td>{{$showStatuses->statusName}}</td>
                                                <td><a style="color: red" href="{{url('statusDataDelete/'.$showStatuses->id)}}" onclick="myFunction()">ลบ</a></td>
                                            </tr> 
                                            @endforeach
                                            @endif
                                        </tbody>
