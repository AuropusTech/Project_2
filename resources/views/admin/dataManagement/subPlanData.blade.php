        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="card">
                            <h3 style="margin-bottom: 20px;"><center>ข้อมูลแผนงานย่อย</center></h3>
                            <div class="bootstrap-data-table-panel">
                                <div class="table-responsive">
                                    <a href="subPlanDataInsert" class="btn btn-success m-b-10 m-l-5" style="float: right; margin-bottom: 10px; margin-right: 5px;">+ เพิ่มข้อมูลแผนงานย่อย</a>
                                    <table id="bootstrap-data-table-list" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                <th>รหัสแผนงานย่อย</th>
                                                <th>ชื่อแผนงานย่อย</th>
                                                <th>ID แผนงาน</th>
                                                <th>ID สาขาวิชา</th>
                                                <th>ชื่อสาขาวิชา</th>
                                                <th>การดำเนินการ</th>
                                       ...
                                       <tbody>
                                            @if($subPlans->count())
                                                @foreach ($subPlans as $showSubPlans)
                                                    <tr>
                                                        <td>{{$showSubPlans->subPlanCode}}</td>
                                                        <td>{{$showSubPlans->subPlanName}}</td>
                                                        <td>{{$showSubPlans->planId}}</td>
                                                        <td>{{$showSubPlans->deptId}}</td>
                                                        <td>{{$showSubPlans->deptName}}</td>
                                                        <td>
                                                            <a style="color: blue" href="subPlanDataEdit/{{$showSubPlans['id']}}">แก้ไขข้อมูล</a>&nbsp;&nbsp;
                                                            <a style="color: red" href="{{url('subPlanDataDelete/'.$showSubPlans->id)}}" onclick="myFunction()">ลบ</a>
                                                        </td>
                                                    </tr> 
                                                @endforeach
                                            @endif
                                    ...
                                    <div style="margin-top: 20px;">
                                        {!! $subPlans->appends(\Request::except('page'))->render() !!}
                                    </div>
