        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="card">
                            <h3 style="margin-bottom: 20px;"><center>แก้ไขข้อมูลหลักผู้บริหาร</center></h3>
                            <div class="bootstrap-data-table-panel">
                                <div class="table-responsive">
                                    <table id="bootstrap-data-table-list" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            @if($Executives->count())
                                            @foreach ($Executives as $showExecutive)
                                            <tr>
                                                <td>{{$showExecutive->id}}</td>
                                                <td>{{$showExecutive->headmenArticleName}}</td>
                                                <td>{{$showExecutive->headmenFname}}</td>
                                                <td>{{$showExecutive->headmenLname}}</td>
                                                <td>{{$showExecutive->headmenPosition}}</td>
                                                <td>{{$showExecutive->headmanStatus}}</td>
                                                <td><a style="color: blue" href="editExecutiveAllProfileID/{{$showExecutive['id']}}">แก้ไข</a></td>
                                            </tr> 
                                            @endforeach
                                            @endif 
                                        </tbody>
