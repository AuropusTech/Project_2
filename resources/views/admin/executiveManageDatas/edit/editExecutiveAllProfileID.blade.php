            ...
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 20px">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="card">
                            <div class="topics">
                                <center><h2 style="margin-bottom: 30px;">แก้ไขข้อมูลผู้บริหาร</h2></center>                                 
                            </div>

                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="/updateExecutiveAllProfileID/{{$Executives['id']}}">
                                        @csrf
                                        <div class="form-group" style="margin-left: 50px">

                                            <div class="row" style="margin-bottom: 20px">
                                                <h6 style="margin: 10px;">คำนำหน้า : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                                                <input id="headmenArticleName" name="headmenArticleName" type="text" class="form-control input-default col-sm-4" required value="{{$Executives->headmenArticleName}}" readonly>

                                            </div>
                                            
                                            <div class="row" style="margin-bottom: 25px">
                                                <h6  style="margin: 10px;">ชื่อ (First Name) : </h6>
                                                <input id="headmenFname" name="headmenFname" type="text" class="form-control input-default col-sm-4" required value="{{$Executives->headmenFname}}" readonly>
                                            ...
                                            <div class="row" style="margin-bottom: 25px">
                                                ...
                                                <input id="headmenLname" name="headmenLname" type="text" class="form-control input-default col-sm-4" required value="{{$Executives->headmenLname}}" readonly>
                                            ...
                                            <div class="row" style="margin-bottom: 25px">
                                                ...
                                                <input id="headmenPosition" name="headmenPosition" type="text" class="form-control input-default col-sm-4" required value="{{$Executives->headmenPosition}}" readonly>

                                            </div>

                                            <div class="row" style="margin-bottom: 25px">
                                                <h6 style="margin: 10px;">สถานะการดำรงตำแหน่ง : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>

                                                <div class="col-sm-3">
                                                    <select id="headmanStatus" name="headmanStatus" class="form-control" style="border-radius: 5px">
                                                        <option value="{{$Executives->headmanStatus}}">{{$Executives->headmanStatus}}</option>
                                                        <option value="" disabled>-- เลือกสถานะ --</option>
                                                        <option value="ดำรงตำแหน่ง">ดำรงตำแหน่ง</option>
                                        ...
                                        <a href="{{ route('executive-all-profile-edit') }}" style="margin-left: 25px; width: 80px;" class="btn btn-danger btn-rounded m-b-10 m-l-5">ยกเลิก</a>
