                            ...
                            <!-- ADD HERE -->
                                <div class="row" style="margin-bottom: 20px">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <div class="card">
                                            <div class="topics">
                                                <center><h2 style="margin-bottom: 30px;">เพิ่มข้อมูลหลักผู้บริหาร</h2></center>                                 
                                            </div>
            
                                            <div class="card-body">
                                                <div class="basic-form">
                                                    <form method="POST" action="{{route('createExecutiveAllProfile')}}">
                                                        @csrf
                                                        <div class="form-group" style="margin-left: 50px">

                                                            <input type="text" name="headmanStatus" value="ดำรงตำแหน่ง" hidden>

                                                            <div class="row" style="margin-bottom: 20px">
                                                                <h6 style="margin: 10px;">คำนำหน้า : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                                                                <div class="col-sm-3">
                                                                    <select id="headmenArticleName" name="headmenArticleName" class="form-control" style="border-radius: 5px">
                                                            ...
                                                            <div class="row" style="margin-bottom: 25px">
                                                                ...
                                                                <input id="headmenFname" name="headmenFname" type="text" class="form-control input-default col-sm-4" required>
                                                            ...
                                                            <div class="row" style="margin-bottom: 25px">
                                                                ...
                                                                <input id="headmenLname" name="headmenLname" type="text" class="form-control input-default col-sm-4" required>
                                                            ...
                                                            <div class="row" style="margin-bottom: 25px">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <select id="headmenPosition" name="headmenPosition" class="form-control" style="border-radius: 5px" required>
