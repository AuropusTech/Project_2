                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="bootstrap-data-table-list" class="table table-striped table-bordered">
                                        ...
                                        <thead>
                                            <tr>
                                                <th>ลำดับที่</th>  
                                                <th>รหัสเอกสาร @sortablelink('ID')</th>
                                                <th>สังกัด</th>                                     
                                       ...
                                       <tbody>
                                            @if($ReqFormbuys->count())      
                                                @foreach ($ReqFormbuys as $ShowReqFormbuys)   
                                                <tr>
                                                    <td>{{ $i++ }}</td>
                                                    <td>{{$ShowReqFormbuys->id}}</td>
                                                    <td>{{$ShowReqFormbuys->BuyFormDept}}</td>
                                                    <td>{{$ShowReqFormbuys->created_at}}</td>
                                                    <td>{{$ShowReqFormbuys->StatusId}}</td>
                                                    <td><a class="btn btn-info btn-rounded m-b-10 m-l-5" href="buyPdfExport/{{$ShowReqFormbuys['id']}}" target="blank" style="margin-right: 10px">Download Pdf Flie</a><a class="btn btn-warning btn-rounded m-b-10 m-l-5" href="form-updateStatusBuy/{{$ShowReqFormbuys['id']}}" style="margin-right: 10px">จัดการสถานะเอกสาร</a></td>
                                                </tr> 
                                                @endforeach     
                                            @endif 
                                    ...
                                    <div style="margin-top: 20px;">
                                        {!! $ReqFormbuys->appends(\Request::except('page'))->render() !!}
                                    </div>
                            ...
                            <div class="bootstrap-data-table-panel">
                                <div class="table-responsive">
                                    ...
                                    <table id="bootstrap-data-table-list" class="table table-striped table-bordered">
                                       ...
                                       <tbody>
                                            @if($ReqFormhires->count())      
                                                @foreach ($ReqFormhires as $ShowReqhires)   
                                                <tr>
                                                    <td>{{ $i++ }}</td>
                                                    <td>{{$ShowReqhires->id}}</td>
                                                    <td>{{$ShowReqhires->HireFormDept}}</td>
                                                    <td>{{$ShowReqhires->created_at}}</td>
                                                    <td>{{$ShowReqhires->StatusId}}</td>
                                                    <td><a class="btn btn-info btn-rounded m-b-10 m-l-5" href="hirePdfExport/{{$ShowReqhires['id']}}" target="blank" style="margin-right: 10px">Download Pdf Flie</a><a class="btn btn-warning btn-rounded m-b-10 m-l-5" href="form-updateStatusHire/{{$ShowReqhires['id']}}" style="margin-right: 10px">จัดการสถานะเอกสาร</a></td>
                                    ...
                                    <div style="margin-top: 20px;">
                                        {!! $ReqFormhires->appends(\Request::except('page'))->render() !!}
                                    </div>
