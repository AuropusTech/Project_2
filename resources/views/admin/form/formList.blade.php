                                       ...
                                       <tbody>
                                            @if($ReqFormbuys->count())      
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-info btn-rounded m-b-10 m-l-5" href="buyPdfExport/{{$ShowReqFormbuys['id']}}" target="blank" style="margin-right: 10px">Download Pdf Flie</a></td>
                                       ...
                                       <tbody>
                                            @if($ReqFormhires->count())      
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-info btn-rounded m-b-10 m-l-5" href="hirePdfExport/{{$ShowReqhires['id']}}" target="blank" style="margin-right: 10px">Download Pdf Flie</a></td>
