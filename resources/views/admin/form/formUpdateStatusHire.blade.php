                ...
                <!-- /# row -->
                            ...
                            <div class="row" style="margin-bottom: 20px">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="card">
                                        <div class="topics">
                                            <center><h2 style="margin-bottom: 30px;">อัพเดทสถานะของเอกสาร</h2></center>                                 
                                        </div>
        
                                        <div class="card-body">
                                            <div class="basic-form">
                                                <form method="POST" action="/form-updatedStatusHire/{{$formHires['id']}}">
                                                    @csrf
                                                    <div class="form-group" style="margin-left: 50px">


                                                        <div class="row" style="margin-bottom: 25px">
                                                            <h6  style="margin: 10px;">รหัสของเอกสาร : </h6>
                                                            <input id="#" name="#" type="text" class="form-control input-default col-sm-6" value="{{$formHires->id}}" readonly>
                                                        </div>


                                                        <div class="row" style="margin-bottom: 20px">
                                                            <h6 style="margin: 10px;">สถานะของเอกสาร : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                                                            <div class="col-sm-4">
                                                                <select id="StatusId'" name="StatusId" class="form-control" style="border-radius: 5px">
                                                                    @foreach ($statuses as $showStatuses)
                                                                        <option value="{{$showStatuses->id}}">{{$showStatuses->statusName}}</option>
                                                                    @endforeach
                                                                </select>
                                                    ...
                                                    <button type="submit" class="btn btn-success btn-rounded m-b-10 m-l-5" onclick="myFunction()">อัพเดทสถานะ</button>
                                                    <a href="{{ route('form-check') }}" style="margin-left: 25px; width: 80px;" class="btn btn-danger btn-rounded m-b-10 m-l-5">ยกเลิก</a>
