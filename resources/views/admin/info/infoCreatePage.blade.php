            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                            ...
                            <h2 style="text-align: center; margin-bottom: 20px">-:- สร้างข่าวประชาสัมพันธ์ -:-</h2> 

                            <div class="card">   
                                <div class="card-body">

                                    <form action="{{ route('infoCreatePost') }}" method="POST" enctype='multipart/form-data'>
                                        @csrf
                                        <div>
                                            <h6 style="margin-top: 10px; margin-bottom: 10px;">ชื่อเรื่อง :</h6>
                                            <input type="text" placeholder="ชื่อเรื่อง" class="form-control input-default col-lg-4" style="margin-top: 10px; margin-bottom: 10px;" name="infoName" required>


                                            <h6 style="margin-top: 10px; margin-bottom: 10px;">เนื้อหา :</h6>
                                            <textarea name="infoContent" cols="30" rows="10"  class="input-default col-lg-10" style="margin-top: 10px; margin-bottom: 10px;"  required></textarea>


                                            <input type="text" style="margin-top: 10px; margin-bottom: 10px;" name="infoAuthorName" value="{{Auth::user()->fname}}&nbsp;{{Auth::user()->lname}}" hidden>

                                        </div>

                                        <div class="row">
                                            <div class="col-md-6">
                                                <a style="float: right" href="admin-information" class="btn btn-danger btn-rounded m-b-10 m-l-5">ยกเลิก</a>
                                            </div>

                                            <div class="col-md-6">
                                                <button style="float: left" class="btn btn-success btn-rounded m-b-10 m-l-5" type="submit" onclick="myFunction()">สร้างข่าว</button>
                                            </div>
                                        </div>
