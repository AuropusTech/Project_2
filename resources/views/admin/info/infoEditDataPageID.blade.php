...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <h2 style="text-align: center; margin-bottom: 20px">-:- แก้ไขข่าวประชาสัมพันธ์ -:-</h2> 

                            <div class="card">   
                                <div class="card-body">

                                    <form action="/infoUpdate/{{$infoAll['id']}}" method="POST">
                                        @csrf
                                        <div>
                                            <h6 style="margin-top: 10px; margin-bottom: 10px;">ชื่อเรื่อง :</h6>
                                            <input type="text" placeholder="ชื่อเรื่อง" class="form-control input-default col-lg-4" style="margin-top: 10px; margin-bottom: 10px;" name="infoName" required value="{{$infoAll->infoName}}">

                                            <h6 style="margin-top: 10px; margin-bottom: 10px;">เนื้อหา :</h6>

                                            <input type="text" name="infoContent" class="form-control input-default col-lg-10" style="margin-top: 10px; margin-bottom: 10px;" required value="{{$infoAll->infoContent}}">
                                            

                                            <input type="text" style="margin-top: 10px; margin-bottom: 10px;" name="infoAuthorName" hidden value="{{$infoAll->infoAuthorName}}">

                                        </div>

                                        <div class="row">
                                            <div class="col-md-6">
                                                <a style="float: right" href="{{ route('infoEdit') }}" class="btn btn-danger btn-rounded m-b-10 m-l-5">ยกเลิก</a>
                                            </div>

                                            <div class="col-md-6">
                                                <button style="float: left" class="btn btn-success btn-rounded m-b-10 m-l-5" type="submit" onclick="myFunction()">ยืนยันการแก้ไข</button>
                                            </div>
                                        </div>
    ...
    <script>
            function myFunction(){alert("ยืนยันการแก้ไขข้อมูล");}
    </script>
