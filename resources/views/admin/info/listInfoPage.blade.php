...
<body>
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="card">   
                            <div class="card-body">
                                ...
                                <h2 style="text-align: center;"> ข่าวประชาสัมพันธ์ทั้งหมด </h2> 
                                ...
                                <table id="bootstrap-data-table-list" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        @if($infoAll->count())      
                                            ...
                                            <tr>
                                                <td>{{ $i++ }}</td>
                                                <td>{{$infoAllData->id}}</td>
                                                <td>{{$infoAllData->infoName}}</td>
                                                <td>{{$infoAllData->infoContent}}</td>
                                                <td>{{$infoAllData->infoAuthorName}}</td>
                                                <td>{{$infoAllData->created_at}}</td>
                                                <td><a href="{{url('infoDelete/'.$infoAllData->id)}}" style="margin-right: 10px; color: red" onclick="myFunction()">ลบ</a></td>
                                            </tr> 
                                            @endforeach     
                                        @endif 
    ...
    <script>
            function myFunction(){alert("ยืนยันการลบข้อมูล");}
    </script>
