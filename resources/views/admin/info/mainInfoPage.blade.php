            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                            ...
                            <h2 style="text-align: center; margin-bottom: 20px">-:- เมนูหลักประชาสัมพันธ์ -:-</h2> 

                            <div class="card">   
                                <div class="card-body">

                                    <h4 style="text-align: left; margin-bottom: 30px;">-:- ข่าวประชาสัมพันธ์ -:-</h4> 


                                    <div class="row" style="margin-left: 50px">
                                        <div class="col-md-12">
                                            <a href="infoCreate" class="btn btn-success btn-rounded m-b-10 m-l-5">สร้างข่าวประชาสัมพันธ์</a>
                                        </div>

                                        <div class="col-md-12">
                                            <a href="infoDisplay" class="btn btn-primary btn-rounded m-b-10 m-l-5">แสดงข่าวประชาสัมพันธ์</a>
                                        </div>

                                        <div class="col-md-12">
                                            <a href="infoEdit" class="btn btn-pink btn-rounded m-b-10 m-l-5">แก้ไขข่าวประชาสัมพันธ์</a>
                                        </div>
                                    </div>
