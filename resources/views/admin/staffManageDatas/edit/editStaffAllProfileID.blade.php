            ...
            <div class="nano-content">
                <ul>
                 ...
                 <li><a class="sidebar-sub-toggle"><i class="ti-user"></i>สำหรับเจ้าหน้าที่พัสดุคณะ<span
                     ...
                     <ul>
                         <li><a href="{{ route('admin-all-profile') }}">ข้อมูลหลักเจ้าหน้าที่พัสดุคณะ</a></li>
                         <li><a href="{{ route('admin-all-profile-edit') }}">แก้ไขข้อมูลเจ้าหน้าที่พัสดุคณะ</a></li>
                         <li><a href="{{ route('admin-add-new') }}">เพิ่มข้อมูลเจ้าหน้าที่พัสดุคณะ</a></li>
                     </ul>
                 </li>
                 ...
                 <li><a class="sidebar-sub-toggle"><i class="ti-user"></i>สำหรับเจ้าหน้าที่พัสดุสาขา<span
                     class="sidebar-collapse-icon ti-angle-down"></span></a>
                     <ul>
                         <li><a href="{{ route('staff-all-profile') }}">ข้อมูลหลักเจ้าหน้าที่พัสดุสาขา</a></li>
                         <li><a href="{{ route('staff-all-profile-edit') }}">แก้ไขข้อมูลเจ้าหน้าที่พัสดุสาขา</a></li>
                         <li><a href="{{ route('staff-add-new') }}">เพิ่มข้อมูลเจ้าหน้าที่พัสดุสาขา</a></li>
                     </ul>
                 </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 20px">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="card">
                            <div class="topics">
                                <center><h2 style="margin-bottom: 30px;">แก้ไขข้อมูลเจ้าหน้าที่พัสดุสาขา</h2></center>                                 
                            </div>

                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="/updateStaffAllProfileID/{{$Users['id']}}">
                                        @csrf
                                        <div class="form-group" style="margin-left: 50px">

                                            <input type="text" name="sysRole" value="เจ้าหน้าที่พัสดุสาขา" hidden>

                                            <div class="row" style="margin-bottom: 20px">
                                                <h6 style="margin: 10px;">คำนำหน้า : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                                                <div class="col-sm-3">
                                                    <select id="articleName'" name="articleName" class="form-control" style="border-radius: 5px">
                                            ...
                                            <div class="row" style="margin-bottom: 25px">
                                                <h6  style="margin: 10px;">ชื่อ (First Name) : </h6>
                                                <input id="fname" name="fname" type="text" class="form-control input-default col-sm-4" required value="{{$Users['fname']}}">

                                            </div>

                                            <div class="row" style="margin-bottom: 25px">
                                                
                                                <h6  style="margin: 10px;">นามสกุล (Last Name) : </h6>
                                                <input id="lname" name="lname" type="text" class="form-control input-default col-sm-4" required value="{{$Users['lname']}}">

                                            </div>


                                            <div class="row" style="margin-bottom: 25px">
                                                <h6 style="margin: 10px;">ตำแหน่ง : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                                                <div class="col-sm-3">
                                                    <select id="position'" name="position" class="form-control" style="border-radius: 5px">
                                                        <option value="{{$Users['position']}}">{{$Users['position']}}</option>
                                                        @foreach ($positions as $showPositions)
                                                            <option value="{{$showPositions->positionType}}">{{$showPositions->positionType}}</option>
                                                        @endforeach
                                            ...
                                            <div class="row" style="margin-bottom: 25px">
                                                <h6  style="margin: 10px;">อีเมล (Email) : &nbsp;&nbsp;&nbsp;&nbsp;</h6>
                                                <input id="email" name="email" type="text" class="form-control input-default col-sm-4" required value="{{$Users['email']}}">
                                            </div> 


                                            <div class="row" style="margin-bottom: 20px">
                                                <h6 style="margin: 10px;">สาขา : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                                                <div class="col-sm-5">
                                                    <select id="deptCode" name="deptCode" class="form-control" style="border-radius: 5px">
                                            ...
                                            <div class="row" style="margin-bottom: 25px">
                                                <h6  style="margin: 10px;">Password : &nbsp;&nbsp;&nbsp;&nbsp;</h6>
                                                <input id="password" name="password" type="password" class="form-control input-default col-sm-4" required>
                                            </div>

                                        </div>

                                        <button type="submit" class="btn btn-success btn-rounded m-b-10 m-l-5" onclick="myFunction()">บันทึก</button>
                                        <a href="{{ route('staff-all-profile-edit') }}" style="margin-left: 25px; width: 80px;" class="btn btn-danger btn-rounded m-b-10 m-l-5">ยกเลิก</a>
