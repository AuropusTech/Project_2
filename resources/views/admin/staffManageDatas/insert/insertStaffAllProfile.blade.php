                ...
                <!-- ADD HERE -->
                                <div class="row" style="margin-bottom: 20px">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <div class="card">
                                            <div class="topics">
                                                <center><h2 style="margin-bottom: 30px;">เพิ่มข้อมูลเจ้าหน้าที่พัสดุสาขา</h2></center>                                 
                                            </div>
            
                                            <div class="card-body">
                                                <div class="basic-form">
                                                    <form method="POST" action="{{route('createStaffAllProfile')}}">
                                                        @csrf
                                                        <div class="form-group" style="margin-left: 50px">
                                                            ...
                                                            <div class="row" style="margin-bottom: 25px">
                                                                ...
                                                                <input id="fname" name="fname" type="text" class="form-control input-default col-sm-4" required>
                                                            ...
                                                            <div class="row" style="margin-bottom: 25px">
                                                                ...
                                                                <input id="lname" name="lname" type="text" class="form-control input-default col-sm-4" required>
                                                            ...
                                                            <div class="row" style="margin-bottom: 25px">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <select id="position'" name="position" class="form-control" style="border-radius: 5px" required>
                                                            ...
                                                            <div class="row" style="margin-bottom: 25px">
                                                                ...
                                                                <input id="email" name="email" type="text" class="form-control input-default col-sm-4" required>
                                                            </div> 
                                                            ...
                                                            <div class="row" style="margin-bottom: 20px">
                                                                ...
                                                                <div class="col-sm-5">
                                                                    <select id="deptCode" name="deptCode" class="form-control" style="border-radius: 5px" required>
                                                        ...
                                                        <a href="admin" style="margin-left: 25px; width: 80px;" class="btn btn-danger btn-rounded m-b-10 m-l-5">ยกเลิก</a>
