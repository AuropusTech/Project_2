        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="card">
                            <h3 style="margin-bottom: 20px;"><center>ข้อมูลหลักเจ้าหน้าที่พัสดุสาขา</center></h3>
                                ...
                                <div class="table-responsive">
                                    <table id="bootstrap-data-table-list" class="table table-striped table-bordered">
                                       ...
                                       <tbody>
                                            ...
                                            <tr>
                                                <td>{{$showUser->id}}</td>
                                                <td>{{$showUser->articleName}}</td>
                                                <td>{{$showUser->fname}}</td>
                                                <td>{{$showUser->lname}}</td>
                                                <td>{{$showUser->position}}</td>
                                                <td>{{$showUser->deptCode}}</td>
                                                <td>{{$showUser->deptName}}</td>
                                                <td>{{$showUser->email}}</td>
                                                <td><a style="color: red" href="{{url('deleteStaffAllProfile/'.$showUser->id)}}" onclick="myFunction()">ลบ</a></td>
                                            </tr> 
                                            @endforeach
                                            @endif 
                                        </tbody>
