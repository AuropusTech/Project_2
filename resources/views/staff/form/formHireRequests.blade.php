            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h3> แบบฟอร์มขอให้จัดจ้างพัสดุ </h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        ...
                        <form action="{{route('hireFormCreate')}}" method="POST">
                            @csrf
                            <div class="card" style="min-width: 1060px;">   
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h2 style="text-align: center;"> แบบฟอร์มขอให้จัดจ้างพัสดุ </h2>
                                            <input type="text" hidden value="{{ Auth::user()->id}}" id="UserId" name="UserId">  
                                            <input type="text" hidden value="1" id="StatusId" name="StatusId">  
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="row" style="float: left;">
                                                        ...
                                                        <select id="HireFormIdDept" name="HireFormIdDept"  class="input-default form-control" style="width: 60px; height: 40px;">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="row" style="float: right;">
                                                    ...
                                                    <input type="text" id="HireFormDate" name="HireFormDate" value="<?php echo $THDateformat;?>" hidden> <!-- ใช้ได้กับทุกวันที่ -->  

                                                    <h6 style="text-align: center; margin-top: 10px; width: 80px; height: 30px;" class="bluetext">วันที่</h6>
                                                    <input style="width: 50px; height: 40px;" class="form-control input-default" type="text" id="HireFormDateD" name="HireFormDateD" value="<?php echo $day;?>" readonly>  

                                                    <h6 style="text-align: center; margin-top: 10px; width: 80px; height: 30px;" class="bluetext">เดือน</h6>
                                                    <input style="width: 120px; height: 40px;" class="form-control input-default" type="text" id="HireFormDateM" name="HireFormDateM" value="<?php echo $monththai[$month];?>" readonly>  

                                                    <h6 style="text-align: center; margin-top: 10px; width: 80px; height: 30px;" class="bluetext">พ.ศ.</h6>
                                                    <input style="width: 70px; height: 40px; margin-right: 20px;" class="form-control input-default" type="text" id="HireFormDateY" name="HireFormDateY" value="<?php echo $year;?>" readonly>  
                                    ...
                                    <h6 style="margin-left: 20px; margin-bottom: 20px; margin-top: 30px;" class="bluetext">เรื่อง ขอให้จัดจ้างพัสดุ </h6>
                                    <h6 style="margin-left: 20px; margin-bottom: 20px;" class="bluetext">เรียน คณบดีคณะวิทยาศาสตร์</h6>
                                        ...
                                        <div class="col-md-12" style="margin-left: 20px;">
                                            <div class="form-group">
                                                ...
                                                <div class="row" style="margin-left: 20px; margin-top: 20px; ">
                                                        ...
                                                        @foreach($user as $row)
                                                            <input style="margin-bottom: 20px; width: 500px; height: 40px;" class="form-control input-default" type="text" value="{{ $row->deptName }}" id="HireFormDept" name="HireFormDept" readonly>  
                                                        @endforeach

                                                        <p style="margin: 10px; margin-bottom: 20px; margin-left: 30px;" class="bluetext">มีความประสงค์ให้</p>


                                                        <select name="HireFormOrder" style="margin-bottom: 20px; width: 180px; height: 40px; margin-left: 10px;" class="form-control">  
                                                            <option value="จัดจ้างเหมาบริการ">จัดจ้างเหมาบริการ</option>
                                                            <option value="จัดจ้างทำของ">จัดจ้างทำของ</option>
                                                            <option value="จัดจ้างซ่อมครุภัณฑ์หมายเลข">จัดจ้างซ่อมครุภัณฑ์</option>
                                                        </select>
                                                ...
                                                <div class="row" style="margin-left: 20px; margin-top: 20px; ">
                                                    ...
                                                    <p style="margin: 10px; margin-bottom: 20px;" class="bluetext">ครุภัณฑ์หมายเลข (*กรณีจัดจ้างซ่อมครุภัณฑ์) </p>

                                                    <input style="margin-bottom: 20px;  width: 150px; height: 40px;" class="form-control input-default" type="text" id="HireFormOrderNo" name="HireFormOrderNo">  

                                                    <p style="margin: 10px; margin-bottom: 20px;" class="bluetext">เนื่องจาก</p>
                                                    
                                                    <input style="margin-bottom: 20px;  width: 400px; height: 40px; margin-left: 20px;" class="form-control input-default" type="text" id="HirePurpose" name="HirePurpose" required>  
                                                ...
                                                <div class="row" style="margin-left: 20px; margin-top: 30px;">
                                                    ...
                                                    <select style="margin-bottom: 20px; width: 250px; height: 40px; margin-left: 10px;" class="form-control" id="HireBudgetYear" name="HireBudgetYear"> 
                                                ...
                                                <div class="row" style="margin-left: 20px;">
                                                    ...
                                                    <select id="HireReceive" name="HireReceive" style="margin-bottom: 20px; width: 280px; height: 40px; margin-left: 10px;" class="form-control"> 
                                                ...
                                                <div class="row" style="margin-left: 20px; margin-top: 10px">
                                                    ...
                                                    <select id="HireBookNoDept" name="HireBookNoDept"  class="input-default form-control" style="width: 60px; height: 40px;"> 
                                                        <option value="{{ Auth::user()->deptCode}}">{{ Auth::user()->deptCode}}</option>
                                                    </select>

                                                    <h6 style="margin-top: 10px;" class="bluetext">&nbsp;&nbsp;./&nbsp;&nbsp;</h6>
                                                    <input class="form-control input-default" style="width: 150px; height: 40px;" placeholder="เลขที่หนังสือ" type="text" id="HireBookNo" name="HireBookNo" required> 


                                                    <p style="margin: 10px; margin-bottom: 20px;" class="bluetext">ลงวันที่</p>
                                                    <select id="HireBookDateD" name="HireBookDateD"  class="input-default form-control" style="width: 80px; height: 40px;" required> 
                                                    ...
                                                    <select id="HireBookDateM" name="HireBookDateM"  class="input-default form-control" style="width: 120px; height: 40px;" required> 
                                                    ...
                                                    <select id="HireBookDateY" name="HireBookDateY"  class="input-default form-control" style="width: 90px; height: 40px;" required> 
                                                ...
                                                <div class="row" style="margin-left: 20px; margin-top: 10px">
                                                    ...
                                                    <input style="margin-bottom: 20px; width: 80px; height: 40px;" class="form-control input-default" type="text" id="HireFormActNo" name="HireFormActNo" required>
                                                ...
                                                <div class="row" style="margin-left: 20px; margin-top: 10px">
                                                    ...
                                                    <input style="margin-bottom: 20px; width: 750px; height: 40px;" class="form-control input-default" type="text" id="HireFormActName" name="HireFormActName" required> 
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body" style="margin-top: 30px">
                                            ...
                                            <div class="table-responsive StaffDESCTB">
                                                ...
                                                <h6>เจ้าหน้าที่จัดทำขอบเขตของงานจ้าง</h6> <br>
                                                    ...
                                                    <tbody> 
                                                        <tr>                                    
                                                            <td id="col0">
                                                                ...
                                                                <select class="form-control" name="HireListScopeUserId[]" required>
                                                            ...
                                                            <td id="col1">
                                                                ...
                                                                <select class="form-control" name="HireListScopeType[]" required>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body" style="margin-top: 30px">
                                            ...
                                            <div class="table-responsive StaffReceiveTB">
                                                ...
                                                <h6>เจ้าหน้าที่ผู้ตรวจรับพัสดุ</h6> <br>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>   
                                                            <td id="colx0">
                                                                ...
                                                                <select name="HireListReceiveUserId[]" class="form-control" required>
                                                                    <option value="">--เลือกรายชื่อ--</option>
                                                                    @foreach ($userData as $showUser)
                                                                        <option value="{{$showUser->id}}">{{$showUser->articleName}}{{$showUser->fname}}&nbsp;{{$showUser->lname}}&nbsp;ตำแหน่ง :&nbsp;{{$showUser->position}}</option>
                                                                    @endforeach
                                                            ...
                                                            <td id="colx1">
                                                                <select class="form-control" name="HireListReceiveType[]" required>
                                                                    <option value="">--เลือกประเภท--</option>
                                                                    <option value="ประธาน">ประธาน</option>
                                                                    <option value="กรรมการ">กรรมการ</option>
                                                                    <option value=""></option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="margin-left: 20px;">
                                            <div class="form-group">
                                                ...
                                                <div class="row" style="margin-right: 210px; float: right;">
                                        ...
                                        <div class="col-md-12" style="margin-left: 20px;">
                                            <div class="form-group">
                                                ...
                                                <div class="row" style="margin-right: 200px; float: right;">
                                                    ...
                                                    <p style="margin: 10px; margin-bottom: 10px;" class="bluetext">ปฏิบัติการแทนอธิการบดีมหาวิทยาลัยขอนแก่น</p>
                                        ...
                                        <div class="col-md-12" style="margin-left: 20px;">
                                            <div class="form-group">
                                                ...
                                                <div class="row" style="margin-left: 20px; margin-top: 20px; ">
                                                        ...
                                                        <p style="margin: 10px; margin-bottom: 20px; margin-left: 20px;" class="bluetext">1) แจ้งความประสงค์ล่วงหน้าก่อนวันที่ต้องการใช้พัสดุ ไม่น้อยกว่า 5 วันทำการ <br>
...
<!-- END Part 1 --> 
                            ...
                            <div class="card" style="min-width: 1060px; margin-top: 50px;">   
                                <div class="card-body">
                                    <h2 style="text-align: center; margin-top: 20px; margin-bottom: 20px"> รายละเอียดของงานจ้าง </h2>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body" style="margin-top: 30px">
                                            ...
                                            <p style="margin: 10px; margin-bottom: 20px; margin-left: 100px;" class="bluetext">1. เหตุผลความจำเป็นที่ต้องจ้าง </p>
                                            <input style="margin-bottom: 20px; margin-left: 100px;" class="form-control input-default col-md-10" type="text" name="HireDescFormReason" required>                                   


                                            <div class="table-responsive DescListTable">

                                                <p style="margin: 10px; margin-bottom: 20px; margin-left: 100px;" class="bluetext">2. รายละเอียดของงานจ้าง</p> <br>
                                                ...
                                                <table class="table table-bordered" id="DescListTable">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td id="colz0"><input class="col-md-12 form-control" type="text" name="hireScopeName[]"/></td>
            
                                                            <td id="colz1"><input class="col-md-12 form-control" type="text" name="hireScopeDesc[]"/></td>
                                    ...
                                    <script>
                                        ...
                                        { 
                                            ...
                                            for(var i =0; i <= cellCount; i++)
                                            {
                                                ...
                                                if(i == 1)
                                                { 
                                                    var radioinput = document.getElementById('colz1').getElementsByTagName('input'); 
                                                    for(var j = 0; j <= radioinput.length; j++)
                                                    { 
                                                        if(radioinput[j].type == 'radio')
                                                        { 
                                                ...
                                                <div class="col-md-12" style="margin-left: 20px;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row" style="margin-left: 20px; margin-top: 20px; ">
                                                                ...
                                                                <p style="margin: 10px; margin-bottom: 20px; margin-left: 50px;" class="bluetext">3. เงื่อนไขในใช้พัสดุประเภทวัสดุหรือครุภัณฑ์ที่ผลิตภายในประเทศ</p>
                                                        ...
                                                        <div class="row" style="margin-left: 30px; margin-top: 20px; ">
                                                            ...
                                                            <input style="margin: 10px; margin-bottom: 20px; margin-left: 60px;" type="checkbox" name="chkbxI" value="/">

                                                            
                                                            <p style="margin: 10px; margin-bottom: 20px; margin-left: 10px;" class="bluetext">
                                                                กำหนดให้ผู้รับจ้างต้องใช้พัสดุประเภทวัสดุหรือครุภัณฑ์ที่ผลิตภายในประเทศไม่น้อยกว่าร้อยละ 60 ของ มูลค่าพัสดุที่จะใช้ในงานจ้างทั้งหมดตามใบสั่งจ้าง
                                                        ...
                                                        <div class="row" style="margin-left: 30px; margin-top: 20px; ">
                                                            ...
                                                            <input style="margin: 10px; margin-bottom: 20px; margin-left: 60px;" type="checkbox" name="chkbxII" value="/">

                                                            
                                                            <p style="margin: 10px; margin-bottom: 20px; margin-left: 10px;" class="bluetext">
                                                                ไม่กำหนด เนื่องจากวัสดุหรือครุภัณฑ์ที่ใช้ในงานจ้างครั้งนี้ไม่มีผลิตภายในประเทศ
                                                            </p>                
                                                        ...
                                                        <div class="row" style="margin-left: 30px; margin-top: 20px; ">
                                                            ...
                                                            <input style="margin: 10px; margin-bottom: 20px; margin-left: 60px;" type="checkbox" name="chkbxIII" value="/">

                                                            
                                                            <p style="margin: 10px; margin-bottom: 20px; margin-left: 10px;" class="bluetext">
                                                                ไม่กำหนด เนื่องจาก จะไม่ใช้พัสดุที่ผลิตภายในประเทศหรือจะใช้หรือใช้พัสดุที่ผลิตภายในประเทศไม่ครบร้อยละ 60 ตามหนังสือขออนุมัติฯ 
                                                            </p>                
                                                        ...
                                                        <div class="row" style="margin-left: 30px; margin-top: 20px; ">
                                                            ...
                                                            <input class="col-md-2 input-default form-control" style="margin-bottom: 10px; margin-left: 10px;" type="text" name="chkbxIIIBookNo">

                                                            <p style="margin: 10px; margin-bottom: 20px; margin-left: 10px;" class="bluetext">ลงวันที่</p>
                                                        
                                                            <input class="col-md-2 input-default form-control" style="margin-bottom: 10px; margin-left: 10px;" type="text" placeholder="วันที่ / เดือน / พ.ศ." name="chkbxIIIDate">
                                                        ...
                                                        <div class="row" style="margin-left: 20px; margin-top: 20px; ">
                                                            ...
                                                            <p style="margin: 10px; margin-bottom: 20px; margin-left: 50px;" class="bluetext">4. แหล่งที่มาของราคากลาง</p>

                                                            <input class="input-default form-control" style="margin-bottom: 10px; margin-left: 10px; width: 310px; height: 40px;" type="text" name="HireFormPriceSrc" required>
                                                        ...
                                                        <div class="row" style="margin-left: 20px; margin-top: 20px; ">
                                                            ...
                                                            <p style="margin: 10px; margin-bottom: 20px; margin-left: 50px;" class="bluetext">5. วงเงินงบประมาณ</p>

                                                            <input class="input-default form-control" style="margin-bottom: 10px; margin-left: 10px; width: 180px; height: 40px;" type="text" name="HireFormBudget" required>
                                                        ...
                                                        <div class="row" style="margin-left: 20px; margin-top: 20px; ">
                                                            ...
                                                            <p style="margin: 10px; margin-bottom: 20px; margin-left: 50px;" class="bluetext">6. กำหนดเวลาให้แล้วเสร็จภายในวันที่ </p>

                                                            <input class="input-default form-control" style="margin-bottom: 10px; margin-left: 10px; width: 180px; height: 40px;" type="text" name="HireFormUseDate" placeholder="วันที่ / เดือน / พ.ศ." required>
                                                        ...
                                                        <div class="row" style="margin-left: 20px; margin-top: 20px; ">
                                                            ...
                                                            <p style="margin: 10px; margin-bottom: 20px; margin-left: 50px;" class="bluetext">7. หลักเกณฑ์ในการพิจารณาคัดเลือกข้อเสนอ</p>

                                                            <input class="input-default form-control" style="margin-bottom: 10px; margin-left: 10px; width: 210px; height: 40px;" type="text" name="HireFormCriteria" value="เกณฑ์ราคา" required>
                                                            ...
                                                            <div class="col-md-12" style="margin-left: 20px;">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="row" style="margin-right: 230px; float: right;">
                                                                        ...
                                                                        <input style="width: 180px; height: 40px;" class="form-control input-default" type="text" id="#" name="#" value="{{  Auth::user()->articleName }}{{  Auth::user()->fname }}&nbsp;{{ Auth::user()->lname }}" readonly>
