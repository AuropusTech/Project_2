                        ...
                        <div class="card">
                            <div class="stat-widget-one">
                              ...
                              <div class="stat-content dib">
                                <div class="stat-text">จำนวนเอกสารแบบฟอร์มการจัดซื้อ</div>
                                <div class="stat-digit">{{$CountReqFormbuys}}</div>
                              </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="stat-widget-one">
                              ...
                              <div class="stat-content dib">
                                <div class="stat-text">จำนวนเอกสารแบบฟอร์มการจัดจ้าง</div>
                                <div class="stat-digit">{{$CountReqFormhires}}</div>
                              </div>
                            </div>
                          </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4" style="margin-left: 60px;">
                        ...
                        <div style=" margin-top: 20px;">
                            ...
                            <a class="btn btn-success btn-outline m-b-10 m-l-5" href="form_buy_requests">ยื่นคำร้องแบบฟอร์มขอให้จัดซื้อ</a>
                        </div>

                        <div style=" margin-top: 20px;">
                            <span class="ti-arrow-circle-right"></span>
                            <a class="btn btn-primary btn-outline m-b-10 m-l-5" href="form_hire_requests">ยื่นคำร้องแบบฟอร์มขอให้จัดจ้าง</a>                  
                        </div>

                        <div style=" margin-top: 20px;">
                            <span class="ti-arrow-circle-right"></span>
                            <a class="btn btn-info btn-outline m-b-10 m-l-5" href="staff-form-list">รายการคำร้องแบบฟอร์ม</a> 
                        </div>

                        <div style=" margin-top: 20px;">
                            <span class="ti-arrow-circle-right"></span>
                            <a class="btn btn-pink btn-outline m-b-10 m-l-5" href="staff-form-check">ตรวจสอบสถานะคำร้อง</a>
                        </div>
                    </div>
